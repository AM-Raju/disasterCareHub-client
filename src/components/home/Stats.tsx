...
const Stats = () => {
  ...
  const emptyBg1 = () => {
    controlStartCardBg1.start({ x: -500, transition: { duration: 1 } });
  };
  ...
  const emptyBg2 = () => {
    controlStartCardBg2.start({ x: -500, transition: { duration: 1 } });
  };
  const fillBg3 = () => {
    controlStartCardBg3.start({ x: 0, transition: { duration: 1 } });
  };
  const emptyBg3 = () => {
    controlStartCardBg3.start({ x: -500, transition: { duration: 1 } });
  };
  const fillBg4 = () => {
    controlStartCardBg4.start({ x: 0, transition: { duration: 1 } });
  };
  const emptyBg4 = () => {
    controlStartCardBg4.start({ x: -500, transition: { duration: 1 } });
  };
    ...
    <Container>
      <div className=" h-40 grid lg:grid-cols-4 relative bottom-16">
        ...
        <div
          ...
          className={` border border-amber-500 flex flex-col relative  justify-center items-center py-7  overflow-hidden h-40`}
        >
          <motion.div
            animate={controlStartCardBg1}
            className={` -translate-x-[500px] bg-amber-500 w-full h-full 
              absolute -z-50`}
          ></motion.div>
        ...
        >
          <motion.div
            ...
            className="-translate-x-[500px] w-full h-full bg-amber-500 absolute -z-50"
          ></motion.div>
